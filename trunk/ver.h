...
#define VER_INTERNALNAME_STR		"devctrl" 

#define str1( x )  #x
#define str2( x )  str1(x)

#define VER_FILEDESCRIPTION_STR		"Device control filter driver " str2(RC_BUILD_OPT)
...
#define VER_LEGALCOPYRIGHT_STR   "Copyright © " VER_COMPANYNAME_STR " 2010."
